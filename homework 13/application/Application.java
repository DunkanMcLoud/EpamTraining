package ru.epam.javacore.lesson_12_io_nio.homework.application;

import ru.epam.javacore.lesson_12_io_nio.homework.application.serviceholder.ServiceHolder;
import ru.epam.javacore.lesson_12_io_nio.homework.application.serviceholder.StorageType;
import ru.epam.javacore.lesson_12_io_nio.homework.cargo.domain.Cargo;
import ru.epam.javacore.lesson_12_io_nio.homework.cargo.domain.CargoField;
import ru.epam.javacore.lesson_12_io_nio.homework.cargo.search.CargoSearchCondition;
import ru.epam.javacore.lesson_12_io_nio.homework.cargo.service.CargoService;
import ru.epam.javacore.lesson_12_io_nio.homework.carrier.service.CarrierService;
...
import ru.epam.javacore.lesson_12_io_nio.homework.common.solutions.search.OrderType;
import ru.epam.javacore.lesson_12_io_nio.homework.common.solutions.utils.CollectionUtils;
import ru.epam.javacore.lesson_12_io_nio.homework.reporting.ReportDefaultService;
import ru.epam.javacore.lesson_12_io_nio.homework.reporting.ReportService;
import ru.epam.javacore.lesson_12_io_nio.homework.storage.initor.InitStorageType;
import ru.epam.javacore.lesson_12_io_nio.homework.storage.initor.StorageInitor;
import ru.epam.javacore.lesson_12_io_nio.homework.transportation.service.TransportationService;
...
import static ru.epam.javacore.lesson_12_io_nio.homework.cargo.domain.CargoField.NAME;
import static ru.epam.javacore.lesson_12_io_nio.homework.cargo.domain.CargoField.WEIGHT;
import static ru.epam.javacore.lesson_12_io_nio.homework.common.solutions.search.OrderType.ASC;
import static ru.epam.javacore.lesson_12_io_nio.homework.common.solutions.search.OrderType.DESC;
import static ru.epam.javacore.lesson_12_io_nio.homework.storage.initor.StorageInitorFactory.getStorageInitor;
