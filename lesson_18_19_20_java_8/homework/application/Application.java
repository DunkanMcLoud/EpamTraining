...
import ru.epam.javacore.lesson_18_19_20_java_8.homework.application.serviceholder.StorageType;
import ru.epam.javacore.lesson_18_19_20_java_8.homework.cargo.domain.Cargo;
import ru.epam.javacore.lesson_18_19_20_java_8.homework.cargo.domain.CargoField;
...
import ru.epam.javacore.lesson_18_19_20_java_8.homework.common.solutions.search.OrderType;
import ru.epam.javacore.lesson_18_19_20_java_8.homework.common.solutions.utils.CollectionUtils;
import ru.epam.javacore.lesson_18_19_20_java_8.homework.reporting.ReportDefaultService;
import ru.epam.javacore.lesson_18_19_20_java_8.homework.reporting.ReportService;
...
import static ru.epam.javacore.lesson_18_19_20_java_8.homework.cargo.domain.CargoField.NAME;
import static ru.epam.javacore.lesson_18_19_20_java_8.homework.cargo.domain.CargoField.WEIGHT;
import static ru.epam.javacore.lesson_18_19_20_java_8.homework.common.solutions.search.OrderType.ASC;
import static ru.epam.javacore.lesson_18_19_20_java_8.homework.common.solutions.search.OrderType.DESC;
...
public class Application {
  ...
  public static void main(String[] args) {
    try {
        ServiceHolder.initServiceHolder(StorageType.SQL);
  ...
  private static void printStorageData() throws SQLException {
  ...
  private static void demoSortOperations() throws SQLException {
  ...
  private static void demoCargoSorting(Collection<CargoField> sortFields, OrderType orderType) throws SQLException {
  ...
  private static void demoReportService() throws ReportException, SQLException {
