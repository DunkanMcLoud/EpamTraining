package ru.epam.javacore.lesson_13_sax_parser_recursion.homework.transportation.repo.impl;


import ru.epam.javacore.lesson_13_sax_parser_recursion.homework.common.solutions.utils.ArrayUtils;
...
import ru.epam.javacore.lesson_13_sax_parser_recursion.homework.transportation.repo.TransportationRepo;

import java.util.Arrays;
import java.util.Collections;
import java.util.List;

import static ru.epam.javacore.lesson_13_sax_parser_recursion.homework.common.business.repo.CommonRepoHelper.findEntityIndexInArrayStorageById;
import static ru.epam.javacore.lesson_13_sax_parser_recursion.homework.storage.Storage.transportationArray;
import static ru.epam.javacore.lesson_13_sax_parser_recursion.homework.storage.Storage.transportationIndex;
...
public class TransportationArrayRepoImpl implements TransportationRepo {
  ...
  public List<Transportation> getAll() {
    Transportation[] transportations = excludeNullableElementsFromArray(transportationArray);
      if (transportations.length == 0) return Collections.emptyList();
      else return Arrays.asList(transportationArray);
  }
