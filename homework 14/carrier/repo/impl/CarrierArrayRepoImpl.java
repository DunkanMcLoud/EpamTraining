...
import static ru.epam.javacore.lesson_13_sax_parser_recursion.homework.storage.Storage.carrierArray;
import static ru.epam.javacore.lesson_13_sax_parser_recursion.homework.storage.Storage.carrierIndex;
...
public class CarrierArrayRepoImpl implements CarrierRepo {
  ...
  public List<Carrier> getAll() {
    Carrier[] carriers = excludeNullableElementsFromArray(carrierArray);
      if (carriers.length == 0) return asList(carriers);
      else return asList(carrierArray);
  }
