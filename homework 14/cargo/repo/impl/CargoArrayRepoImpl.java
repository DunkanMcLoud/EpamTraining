...
import static ru.epam.javacore.lesson_13_sax_parser_recursion.homework.storage.Storage.cargoArray;
import static ru.epam.javacore.lesson_13_sax_parser_recursion.homework.storage.Storage.cargoIndex;
...
public class CargoArrayRepoImpl extends CommonCargoRepo {
  ...
  public List<Cargo> getAll() {
    Cargo[] cargos = excludeNullableElementsFromArray(cargoArray);
      if (cargos.length == 0) return Collections.emptyList();
      else return Arrays.asList(cargoArray);
  }
