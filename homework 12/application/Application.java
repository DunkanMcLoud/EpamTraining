package ru.epam.javacore.lesson_11_generics_and_io.homework.application;

import ru.epam.javacore.lesson_11_generics_and_io.homework.application.serviceholder.ServiceHolder;
import ru.epam.javacore.lesson_11_generics_and_io.homework.application.serviceholder.StorageType;
...
import ru.epam.javacore.lesson_11_generics_and_io.homework.common.solutions.utils.CollectionUtils;
import ru.epam.javacore.lesson_11_generics_and_io.homework.storage.exporter.StorageFileExporter;
import ru.epam.javacore.lesson_11_generics_and_io.homework.storage.initor.InitStorageType;
import ru.epam.javacore.lesson_11_generics_and_io.homework.storage.initor.StorageInitor;
...
import static ru.epam.javacore.lesson_11_generics_and_io.homework.cargo.domain.CargoField.NAME;
import static ru.epam.javacore.lesson_11_generics_and_io.homework.cargo.domain.CargoField.WEIGHT;
import static ru.epam.javacore.lesson_11_generics_and_io.homework.common.solutions.search.OrderType.ASC;
import static ru.epam.javacore.lesson_11_generics_and_io.homework.common.solutions.search.OrderType.DESC;
import static ru.epam.javacore.lesson_11_generics_and_io.homework.storage.initor.StorageInitorFactory.getStorageInitor;
...
public class Application {
  ...
  public static void main(String[] args) {
    try {
      ...
      StorageInitor storageInitor = getStorageInitor(InitStorageType.XML);
      storageInitor.initStorage();

      printStorageData();
      StorageFileExporter.writeStorageInFile();
