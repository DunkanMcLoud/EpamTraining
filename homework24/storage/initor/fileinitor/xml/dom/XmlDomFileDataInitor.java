package ru.epam.javacore.lesson_18_19_20_java_8.homework.storage.initor.fileinitor.xml.dom;
...
import ru.epam.javacore.lesson_18_19_20_java_8.homework.cargo.domain.CargoType;
...
import ru.epam.javacore.lesson_18_19_20_java_8.homework.common.solutions.utils.DateHandler;
import ru.epam.javacore.lesson_18_19_20_java_8.homework.common.solutions.utils.FileUtils;
import ru.epam.javacore.lesson_18_19_20_java_8.homework.common.solutions.utils.xml.dom.XmlDomUtils;
import ru.epam.javacore.lesson_18_19_20_java_8.homework.storage.initor.fileinitor.BaseFileInitor;
...
import static ru.epam.javacore.lesson_18_19_20_java_8.homework.common.solutions.utils.xml.dom.XmlDomUtils.getOnlyElement;
import static ru.epam.javacore.lesson_18_19_20_java_8.homework.common.solutions.utils.xml.dom.XmlDomUtils.getOnlyElementTextContent;
...
public class XmlDomFileDataInitor extends BaseFileInitor {
  ...
  private Map.Entry<String, Cargo> parseCargo(Node cargoXml) throws ParseException {
    ...
    if (CargoType.FOOD.equals(cargoType)) {
      ...
      Date expirationDate = DateHandler.getDateParserWithoutTime().parse(getOnlyElementTextContent(cargoElem, "expirationDate"));
  ...
  private ParsedTransportation parseTransportationData(Node transportationXml)
    ...
    transportation.setTransportationBeginDate(DateHandler.getDateParserWithTime().parse(beginDataStr));
