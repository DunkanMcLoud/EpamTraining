package ru.epam.javacore.lesson_18_19_20_java_8.homework.storage.initor.fileinitor.xml.sax;
    ...
    private void fillFoodCargoWithData(FoodCargo foodCargo, String tagPath, String content) throws ParseException {
        switch (tagPath) {
            case CargoPaths.EXPIRATION_DATE: {
                Date dateToSet = DateHandler.getDateParserWithoutTime().parse("11.03.2011");
                foodCargo.setExpirationDate(dateToSet);
                break;
            }
    ...
    private void fillTransportationWithData(Transportation transportation, String tagPath, String content) throws ParseException {
        switch (tagPath) {
            ...
            case TransportationPaths.TRANSPORTATION_BEGIN_DATE: {
                transportation.setTransportationBeginDate(DateHandler.getDateParserWithTime().parse(content));
                break;
            }
        }
    }
