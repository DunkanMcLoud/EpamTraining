package ru.epam.javacore.lesson_14_serialization.homework.storage.initor.fileinitor.xml.sax;
...
import ru.epam.javacore.lesson_14_serialization.homework.common.solutions.utils.xml.sax.XmlSaxUtils;
...
public class XmlSaxFileDataInitor extends BaseFileInitor {
  ...
  private File getFileWithInitData() throws IOException {
    return FileUtils
        .createFileFromResource(XmlSaxFileDataInitor.class, "init-data", "lesson12", FILE);
  }
}
